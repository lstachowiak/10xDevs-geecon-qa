...
describe("POST /api/sessions/:slug/questions", () => {
  ...
  it("should return 201 and create question with valid data", async () => {
    ...
    expect(createQuestion).toHaveBeenCalledWith({}, "session-123", {
      content: "Valid question?",
      authorName: "Anonymous",
    });
  });
...
describe("GET /api/sessions/:slug/questions", () => {
  ...
  it("should return 200 with all questions when includeAnswered is true", async () => {
    // Arrange
    mockContext.request = new Request("http://localhost/api/sessions/test-slug/questions?includeAnswered=true", {
      method: "GET",
    });
  ...
  it("should return 200 with only unanswered questions when includeAnswered is false", async () => {
    // Arrange
    mockContext.request = new Request("http://localhost/api/sessions/test-slug/questions?includeAnswered=false", {
      method: "GET",
    });
  ...
  it("should return 400 when includeAnswered is invalid", async () => {
    // Arrange
    mockContext.request = new Request("http://localhost/api/sessions/test-slug/questions?includeAnswered=maybe", {
      method: "GET",
    });
  ...
  it("should handle includeAnswered=1 (numeric true)", async () => {
    // Arrange
    mockContext.request = new Request("http://localhost/api/sessions/test-slug/questions?includeAnswered=1", {
      method: "GET",
    });
  ...
  it("should handle includeAnswered=0 (numeric false)", async () => {
    // Arrange
    mockContext.request = new Request("http://localhost/api/sessions/test-slug/questions?includeAnswered=0", {
      method: "GET",
    });
